...
import com.badlogic.gdx.backends.android.IAndroidInput;
...
public class AndroidControllers implements IAndroidInput, View.OnGenericMotionListener, LifecycleListener, ControllerManager {
	...
	public AndroidControllers() {
		...
		setupEventQueue();
		((IAndroidInput) Gdx.input).addKeyListener(this);
	...
	@Override
	public void addKeyListener(View.OnKeyListener androidControllers) {
