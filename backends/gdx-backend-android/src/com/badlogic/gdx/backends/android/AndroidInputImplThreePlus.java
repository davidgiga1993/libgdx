...
/**
 * Subclass of AndroidInputImpl, used on Android +3.x to get generic motion events for things like gamepads/joysticks and so on.
 *
 * @author mzechner
 */
public class AndroidInputImplThreePlus extends AndroidInputImpl implements OnGenericMotionListener {
	ArrayList<OnGenericMotionListener> genericMotionListeners = new ArrayList();
	private final AndroidMouseHandler mouseHandler;

	public AndroidInputImplThreePlus(Application activity, Context context, Object view, AndroidApplicationConfiguration config) {
