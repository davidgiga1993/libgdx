...
/**
 * GLES20 backend - can be used on desktops in conjunction with google angle
 * This allows directX, vulkan, metal and other backends.
 * This will also enable RDP support
 */
class Lwjgl3GLES20 implements DesktopGL20 {
	...
	public String glGetActiveAttrib(int program, int index, IntBuffer size, Buffer type) {
		...
		String name = GLES20.glGetActiveAttrib(program, index, 256, size, typeTmp);
	...
	public String glGetActiveUniform(int program, int index, IntBuffer size, Buffer type) {
		IntBuffer typeTmp = BufferUtils.createIntBuffer(2);
		String name = GLES20.glGetActiveUniform(program, index, 256, size, typeTmp);
		size.put(typeTmp.get(0));
		if (type instanceof IntBuffer) ((IntBuffer) type).put(typeTmp.get(1));
		return name;
	}
